...
<section id="services" class="services section">
  ...
  <div class="container" data-aos="fade-up">
    <h2>บริการรับฟาร์ม</h2>
    <p>บริการรับฟาร์มจากเกมที่คุณชื่นชอบ ทั้ง KING LEGACY, BLOX FRUIT, และ Fisch พร้อมทีมงานมืออาชีพ!</p>
  </div>
  ...
  <div class="container">
    <div class="row gy-4">
      ...
      <div class="col-xl-4 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
        <div class="service-item">
          <div class="service-icon">
            <img src="assets/img/gamepass.png" alt="KING LEGACY">
          </div>
          <h4><a href="king-legacy.php" class="stretched-link">KING LEGACY</a></h4>
          <p>รับฟาร์มเลเวล, ไอเท็ม, และทรัพยากรต่างๆ ในเกม KING LEGACY โดยทีมงานที่เชี่ยวชาญ</p>
        </div>
      </div>
      ...
      <div class="col-xl-4 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="200">
        <div class="service-item">
          <div class="service-icon">
            <img src="assets/img/gamepass.png" alt="BLOX FRUIT">
          </div>
          <h4><a href="blox-fruit.php" class="stretched-link">BLOX FRUIT</a></h4>
          <p>ฟาร์มเลเวล, เงิน, และผลไม้หายากใน BLOX FRUIT พร้อมความปลอดภัย 100%</p>
        </div>
      </div>
      ...
      <div class="col-xl-4 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="300">
        <div class="service-item">
          <div class="service-icon">
            <img src="assets/img/gamepass.png" alt="Fisch">
          </div>
          <h4><a href="fisch.php" class="stretched-link">Fisch</a></h4>
          <p>รับฟาร์มเลเวลในแมพ Fisch อย่างรวดเร็วและปลอดภัย โดยทีมงานที่พร้อมช่วยคุณทุกขั้นตอน</p>
        </div>
      </div>
    </div>
  </div>
