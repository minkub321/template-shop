    ...
    <div class="row gy-4">
      ...
      <div class="col-xl-6 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
        <div class="service-item">
          ...
          <p>ไก่ตันธรรมดา เหมาะสำหรับผู้ที่ต้องการความคุ้มค่าในราคาที่จับต้องได้ พร้อมช่วยคุณพัฒนาเกมอย่างรวดเร็ว</p>
        </div>
      </div>
      ...
      <div class="col-xl-6 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="200">
        <div class="service-item">
          ...
          <p>ไก่ตันเทพ เหมาะสำหรับผู้ที่ต้องการประสิทธิภาพสูงสุด เพื่อความได้เปรียบและความสำเร็จในเกม</p>
        </div>
      </div>
    </div>
  </div>
